...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (go-autocomplete flymake-go go-guru auto-complete exec-path-from-shell go-mode paredit geiser yaml-mode flycheck-pyflakes flycheck swiper smex jedi magit))))
(custom-set-faces
